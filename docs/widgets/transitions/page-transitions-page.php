...
<div data-role = "page" id = "page-success" data-dom-cache = "true"><!-- page-->
	...
	<div data-role = "content" data-theme = "d">
		<p>That was an animated page transition effect to a page that we added with a <code>data-transition</code>
			attribute on the link. This uses a different background theme swatch to see how that looks with the
			transitions.</p>
		...
		<a href = "index.php" data-role = "button" data-theme = "b" data-rel = "back" data-inline = "true">Take me
			back</a>
	</div>
