...
<div data-role = "page" class = "jqm-demos" data-quicklinks = "true">
	...
	<div data-role = "content" class = "jqm-content">
		...
		<div data-demo-html = "true">
			<div class = "ui-grid-a">
				<div class = "ui-block-a">
					<button data-theme = "b">Confirm</button>
				</div>
				<div class = "ui-block-b">
					<button data-theme = "d">Cancel</button>
				</div>
			</div>
		</div>
		<!--/demo-html -->
		...
		<p>It's not recommended to have many buttons with text on one row at small screens, because the text might get
			truncated. You can use <a href = "./">responsive grids</a> to stack the buttons at small screens. Here we
			use the framework preset breakpoint by adding class <code>ui-responsive</code> to the container.</p>

		<div data-demo-html = "true">
			<div class = "ui-grid-b ui-responsive">
				<div class = "ui-block-a"><a href = "#" data-role = "button" data-icon = "arrow-l">Back to order</a>
				</div>
				<div class = "ui-block-b">
					<button data-icon = "plus">Add products</button>
				</div>
				<div class = "ui-block-c">
					<input type = "button" data-icon = "check" data-iconpos = "right" value = "Confirm order"></div>
			</div>
		</div>
		<!--/demo-html -->
