...
<p class = "jqm-intro">All form widgets begin with native form elements with rich HTML semantics that are enhanced to
	make them more attractive and finger-friendly.
</p>
...
<div data-demo-html = "true">
	...
	<a href = "#" data-role = "button" data-inline = "true" data-icon = "plus" data-iconpos = "notext" data-theme = "e" data-mini = "true">icon
		only button</a>
</div>
<!-- /demo-html -->
...
<p>Range sliders offer two handles to set a min and max value along a numeric continuum. Learn more about
	<a href = "../sliders/rangeslider.php" data-ajax = "false">range sliders</a>.</p>
...
<p>Flip switches are used for boolean style inputs like true/false or on/off in a compact UI element. Learn more about
	<a href = "../sliders/switch.php" data-ajax = "false">flip switches</a>.</p>
...
<p>Checkboxes are used to provide a list of options where more than one can be selected. Learn more about
	<a href = "../checkbox/">checkboxes</a>.</p>
...
<p>Radio buttons are used to provide a list of options where only a single option can be selected. Learn more about
	<a href = "../radiobuttons/">radiobuttons</a>.</p>
...
<p>For the sake of accessibility, jQuery Mobile requires that all form elements be paired with a meaningful
	...
	to the label. View more examples of <a href = "form-label-hidden.php">accessibly hidden labels</a>. In case you use
	a field container you can use class <code>ui-hide-label</code> on the element with
	<code>data-role="fieldcontain"</code> to <a href = "form-hide-label.php">hide the label or legend</a>.</p>
...
<p>All jQuery Mobile widgets can be disabled in the markup by adding the standard <code>disabled</code> attribute to the
	...
	<code>enable</code> methods that are documented with each form widget. View more examples of
	<a href = "form-disabled.php">disabled form elements</a>.</p>
...
<p>To improve the styling of labels and form elements on wider screens, wrap a <code>div</code> or
	...
	~448px. The framework will also add a thin bottom border to act as a field separator. See more examples of
	<a href = "form-fieldcontain.php">fieldcontainer groupings</a>.</p>
