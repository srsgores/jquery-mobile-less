	...
	<div data-role = "content" class = "jqm-content">
		...
		<ul data-role = "listview" data-theme = "d" data-dividertheme = "e" data-filter = "true" data-filter-theme = "d" data-filter-placeholder = "Search albums..." data-split-icon = "gear" data-split-theme = "c">
			<li><a href = "#">
				...
				<p>Broken Bells</p>
			</a><a href = "../lists/lists-split-purchase.html" data-rel = "dialog" data-transition = "slideup">Purchase
				album
			</a></li>
			<li><a href = "#">
	...
	<div data-role = "footer" data-id = "foo1" data-position = "fixed">
		<div data-role = "navbar">
			<ul>
				...
				<li><a href = "footer-persist-c.html" data-prefetch = "true" class = "ui-btn-active ui-state-persist">Albums</a>
				</li>
